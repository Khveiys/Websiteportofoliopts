...
<html lang="en">
  <head>
    ...
    <title>Khansa Veasna Reiko Archie - Portofolio</title>
  </head>
  <body>
    <!-- Header -->
    <header>
      <div class="main-container">
        ...
        <section id="hero">
          <div class="hero-left">
            <h1 class="hero-name">Halo! Nama Saya <span class="typing-text"></span><span id="typed"></span><span class="cursor"></span></h1>
            <p>
              Saya Khansa Veasna Reiko Archie bersekolah di SMK Telkom Purwokerto jurusan PPLG, saya merupakan siswa yang kreatif, disiplin dan menyukai tantangan baru.
            </p>
          </div>

          <div class="hero-right">
            <img src="mainphoto.jpeg" alt="Person Standing" />
          </div>
        </section>
      </div>
    </header>
    ...
    <section id="about">
      <div class="services main-container">
        <h1 class="about main-container">About me</h1>
          ...
          <div class="skills-left">
            <div class="education">
              ...
              <div class="education-info">
                <h4 class="education-title">SD Negeri Karangrau</h4>
                <p>2015 - 2021</p>
              </div>
            </div>
            <div class="education">
      ...
      <div class="contact main-container">
        <div class="contact-left">
          ...
          >
            ...
            <div>
              <button name="submit" class="btn-submit">Send Message</button>
            </div>
          </form>
        </div>
        ...
        <div class="contact-right">
          <div class="contact-item">
            ...
            <div class="contact-item-detail">
              <h4>Alamat</h4>
              <p class="veas">Perumahan Bumi Teluk Permai RT02 RW17 Blok G23/24, Purwokerto Selatan</p>
            </div>
          </div>
    ...
    <footer>
      ...
      <p>&#169; 2025 - Made by Khansa Veasna Reiko Archie</p>
    </footer>
    <!-- End Footer -->
